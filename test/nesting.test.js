...
const colWidth = (currentCols, colSpace, totalCols, width) => ((width - colSpace * (totalCols - 1)) / totalCols) * currentCols + (currentCols - 1) * colSpace
...
test('Nested cols get the proper widths.', () => {
  ...
  expect(firstNestedGrid.props.style[0]).toEqual(wrapperStyles())
  expect(secondNestedGrid.props.style[0]).toEqual(wrapperStyles())
  ...
  expect(firstNestedGridFirstCol.props.style.width).toEqual(colWidth(1, colSpace, 4, nestedViewWidth))
  ...
  expect(firstNestedGridSecondCol.props.style.width).toEqual(colWidth(2, colSpace, 4, nestedViewWidth))
  ...
  expect(secondNestedGridFirstCol.props.style.width).toEqual(colWidth(3, colSpace, 4, nestedViewWidth))
  ...
  expect(secondNestedGridSecondCol.props.style.width).toEqual(colWidth(1, colSpace, 4, nestedViewWidth))
